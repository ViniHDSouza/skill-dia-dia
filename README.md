...
A curated collection of **14 agent skills** for everyday software development — covering guardrails, planning, implementation workflows, code review, and continuous learning. Stack-agnostic skills that enhance an agent's ability to write better code, debug systematically, and deliver with evidence.
...
Docs atualizados, execução em batches e infraestrutura.
